...
import com.github.b583.catregistry.persistence.CatEntity;
...
class CatRegistryMainApplication extends Application<CatRegistryMainConfiguration> {
    ...
    private final HibernateBundle<CatRegistryMainConfiguration> hibernateBundle = new HibernateBundle<>(CatEntity.class) {
        @Override
